package cd.synapsehub.smartgeotools.activities;
...
import cd.synapsehub.smartgeotools.anim.AnimationUtils;
import cd.synapsehub.smartgeotools.extras.SortListener;
import cd.synapsehub.smartgeotools.fragments.FragmentBoxOffice;
import cd.synapsehub.smartgeotools.fragments.FragmentDrawer;
import cd.synapsehub.smartgeotools.fragments.FragmentSearch;
import cd.synapsehub.smartgeotools.fragments.FragmentUpcoming;
import cd.synapsehub.smartgeotools.logging.L;
import cd.synapsehub.smartgeotools.materialdesign.R;
import cd.synapsehub.smartgeotools.services.ServiceMoviesBoxOffice;
