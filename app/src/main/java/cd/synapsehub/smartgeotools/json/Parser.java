...
import cd.synapsehub.smartgeotools.extras.Constants;
import cd.synapsehub.smartgeotools.pojo.Movie;

import static cd.synapsehub.smartgeotools.extras.Keys.EndpointBoxOffice.KEY_AUDIENCE_SCORE;
import static cd.synapsehub.smartgeotools.extras.Keys.EndpointBoxOffice.KEY_CAST;
import static cd.synapsehub.smartgeotools.extras.Keys.EndpointBoxOffice.KEY_ID;
import static cd.synapsehub.smartgeotools.extras.Keys.EndpointBoxOffice.KEY_LINKS;
import static cd.synapsehub.smartgeotools.extras.Keys.EndpointBoxOffice.KEY_MOVIES;
import static cd.synapsehub.smartgeotools.extras.Keys.EndpointBoxOffice.KEY_POSTERS;
import static cd.synapsehub.smartgeotools.extras.Keys.EndpointBoxOffice.KEY_RATINGS;
import static cd.synapsehub.smartgeotools.extras.Keys.EndpointBoxOffice.KEY_RELEASE_DATES;
import static cd.synapsehub.smartgeotools.extras.Keys.EndpointBoxOffice.KEY_REVIEWS;
import static cd.synapsehub.smartgeotools.extras.Keys.EndpointBoxOffice.KEY_SELF;
import static cd.synapsehub.smartgeotools.extras.Keys.EndpointBoxOffice.KEY_SIMILAR;
import static cd.synapsehub.smartgeotools.extras.Keys.EndpointBoxOffice.KEY_SYNOPSIS;
import static cd.synapsehub.smartgeotools.extras.Keys.EndpointBoxOffice.KEY_THEATER;
import static cd.synapsehub.smartgeotools.extras.Keys.EndpointBoxOffice.KEY_THUMBNAIL;
import static cd.synapsehub.smartgeotools.extras.Keys.EndpointBoxOffice.KEY_TITLE;
